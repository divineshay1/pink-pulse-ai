...
// NOTE: mock data for the UI shell. Step 2 wires this to Binance/Coinbase/CoinGecko
// and the rule-based signal engine (RSI, VWAP, MTF trend, etc.) from kalshi-btc-tool.
const MOCK = {
  price: 71482.16,
  change24h: 2.34,
